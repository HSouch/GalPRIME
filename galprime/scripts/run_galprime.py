...
def main():
    ...
    parser.add_argument("--min_objs_per_bin", type=int, default=10, help="Minimum number of objects required for a valid bin.")
    ...
    binlist = gp.bin_catalogue(object_catalogue, min_objects=args.min_objs_per_bin, 
                            bin_params=config["BINS"], params=config["KEYS"], logger=logger)
